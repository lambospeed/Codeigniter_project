    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-12">
          <div class="row">
            <main class="cd-main-content"><a href="javascript:;" id="toggle-right-cd"><img src="<?php site_url()?>/assets/img/cd-icon-filter-hover.svg"/></a>
              <div class="filter-filter">
                <div class="title-cat">
                  <h2><img src="<?php site_url()?>/assets/img/cd-icon-filter-hover.svg" />Category</h2>
                </div>
                <div class="cd-filter filter-is-visible">
                  <form>
                    <div class="cd-filter-block">
                      <h4>Search</h4>
                      <div class="cd-filter-content"><input type="search" placeholder="Try web-designing..."></div>
                    </div>
                    <div class="cd-filter-block">
                      <h4>Check boxes</h4>
                      <ul class="cd-filter-content cd-filters list">
                        <li><input class="filter" data-filter=".front-end" type="checkbox" id="checkbox1"><label class="checkbox-label"
                            for="checkbox1">Front End Designer</label></li>
                        <li><input class="filter" data-filter=".back-end" type="checkbox" id="checkbox2"><label class="checkbox-label"
                            for="checkbox2">Back End Designer</label></li>
                        <li><input class="filter" data-filter=".graphics" type="checkbox" id="checkbox3"><label class="checkbox-label"
                            for="checkbox3">Graphics Designer</label></li>
                      </ul>
                    </div>
                    <div class="cd-filter-block">
                      <h4>Select</h4>
                      <div class="cd-filter-content">
                        <div class="cd-select cd-filters"><select class="filter" name="selectThis" id="selectThis"><option value="">Choose an option</option><option value=".option1">Option 1</option><option value=".option2">Option 2</option><option value=".option3">Option 3</option><option value=".option4">Option 4</option></select></div>
                      </div>
                    </div>
                    <div class="cd-filter-block">
                      <h4>Radio buttons</h4>
                      <ul class="cd-filter-content cd-filters list">
                        <li><input class="filter" data-filter="" type="radio" name="radioButton" id="radio1" checked><label class="radio-label"
                            for="radio1">All</label></li>
                        <li><input class="filter" data-filter=".html" type="radio" name="radioButton" id="html"><label class="radio-label"
                            for="html">Html</label></li>
                        <li><input class="filter" data-filter=".php" type="radio" name="radioButton" id="php"><label class="radio-label"
              ...
              <div class="filter-main">
                <section class="cd-gallery filter-is-visible">
                  <ul>
                    <li class="mix web-designing front-end html option3">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                              <div class="serves-hover">
                                <div class="hover-ser">
                                  <div class="col-md-12"><a class="hover-eye" href="inner-service.html" data-toggle="tooltip" title="View Detail"><i class="fa fa-eye"></i></a>
                                    <i data-toggle="modal" data-target="#sendgiftmethod" title="Sent it as Gift " class="service_box_fav_btn favourite_serv_btn fa fa-gift"></i>
                                  </div>
                                  <div class="col-md-12 share-n">
                                    <h5>Share Now </h5><a href="http://facebook.com" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>                                    <a class="btn btn-social-icon btn-google-plus"><i class="fa fa-google-plus"></i></a>
                                    <a
                                      class="btn btn-social-icon btn-linkedin"><i class="fa fa-linkedin"></i></a><a class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>                                      </div>
                                </div>
                              </div>
                            </div>
                            <div class="list-td">
                              <div class="service_title"><a href="buy-services.html#">create 300 EDU Backlinks for ANY WEBSITE &nbsp;</a>
                                <div class="pro-descr">
                                  <p>Last January, a 21-year-old woman who worked in a small shop in West Delhi's Kirti Nagar
                                    area committed suicide. When police officials finally managed to get in touch with her
                                    mother in Assam 12 days later, she asked if her daughter's </p>
                                </div><span> <span class="glyphicon glyphicon-star star-active"></span><span class="glyphicon glyphicon-star star-active"></span>
                                <span
                                  class="glyphicon glyphicon-star star-active"></span><span class="glyphicon glyphicon-star star-active"></span><span class="glyphicon glyphicon-star star-active"></span></span>
                                  <span
                                    class="item-price"><i class="fa fa-inr"></i> 450</span>
                              </div>
                              <div class="service_meta"><a href="buy-services.html#" class="by-now"><i class="fa fa-heart"></i>+ favorite</a><a href="buy-services.html#"
                                  data-toggle="modal" data-target="#paymentmethod" class="by-now"><i class="fa fa-shopping-cart"></i>Buy now</a></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    </li>
                    <li class="mix web-devlopment back-end html option2">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-designing graphics php option1">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                              <div class="serves-hover">
                                <div class="hover-ser">
                                  <div class="col-md-12"><a class="hover-eye" href="inner-service.html" data-toggle="tooltip" title="View Detail"><i class="fa fa-eye"></i></a>
                                    <i data-toggle="modal" data-target="#sendgiftmethod" title="Sent it as Gift"sendgiftmethod class="service_box_fav_btn favourite_serv_btn fa fa-gift"></i>
                                  </div>
                                  <div class="col-md-12 share-n">
                                    <h5>Share Now </h5><a href="http://facebook.com" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>                                    <a class="btn btn-social-icon btn-google-plus"><i class="fa fa-google-plus"></i></a>
                                    <a
                    ...
                    <li class="mix web-designing graphics html option4">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-designing front-end php option2">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-devlopment back-end php option3">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-devlopment back-end html option1">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-designing front-end php option4">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-devlopment front-end html option3">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-designing graphics php option2">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                    ...
                    <li class="mix web-devlopment front-end php option1">
                      <div class="thumbnail">
                        <div class="servbox" id="products">
                          <div class="service_details featured_service">
                            <div class="srvice_box "><img src="<?php site_url()?>/assets/img/portfolio/06.jpg" alt="SEO - Search Engine Optimization">
                        ...
                        <div class="col-sm-12 col-xs-12">
                          ...
                          <div class="pull-right">
                            <ul class="footer-social">
                              <li><a href="buy-services.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                              <li><a href="buy-services.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                              <li><a href="buy-services.html#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                              <li><a href="buy-services.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
  ...
  <!-- Modal -->
  <div id="paymentmethod" class="modal fade payment-body" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="height:640px;">
        <div class="modal-header">
          ...
          <p class="modal-title" style="text-align: center;">Purchase Service</>
        </div>
        ...
        <div class="main">
          <div class='payments' style="padding-left:60px;margin-left:0px;">
            <div class='button col-md-3 active' style="font-color:black;">
              <text style="font-size:14px;color:green;">Credit Card</text>
              <svg class="svg-visa" viewBox="0 0 512 512">
                <text x="0" y="3" fill="red">I love SVG!</text>
            ...
            <div class='button col-md-3' style="margin-left:20px;">
              <text style="font-size:14px;color:green;">Sofort Banking</text>
            ...
            <div class='button col-md-3' style="margin-left:20px;">
              <text style="font-size:14px;color:green;">PayPal</text>
            ...
            <div class='button col-md-3' style="margin-left:20px;">
              <text style="font-size:14px;color:green;">GiroPay</text><br>
              <img src="<?php site_url()?>/assets/img/giropay.png">
                
            </div>
          </div>
        </div>
        <div class="row" style="font-size:16px;color:black;text-align: left; margin-top:0px;">
              <div class="col-md-12" style="text-align: center;padding-bottom: 10px;border-top :#dedede 1px solid;margin-left:20px;margin-right: 20px;width:94%;">
              ...
              <div class="col-md-4 col-md-offset-2">
                <div class="col-md-12">
                    <div class="controls input-append date form_date" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                        ...
                        <input size="16" type="text" value="" placeholder="Select Date" style="padding-left:10px;border: #fff 1px solid;border-bottom: #dedede 1px solid;width:80%;">
              ...
              <div class="col-md-4">
                <div class="col-md-12">
                    ...
                    <span class="add-on"><i class="fa fa-clock-o"></i></span>
                        <input size="16" type="text" value="" placeholder="Select Time" style="padding-left:10px;border: #fff 1px solid;border-bottom: #dedede 1px solid;width:80%;">
              ...
              <div class="col-md-12" style="padding-bottom: 10px;border-top :#dedede 1px solid;margin-left:20px;margin-right: 20px;width:94%;">
              </div>
              <script type="text/javascript">
        ...
        <div class="col-md-12">
            <textarea name="editorX" id="editorX" rows="3" cols="40" style="height: 200px;" placeholder="Make an appointment."></textarea>
            <script type="text/javascript">
        ...
        <center>
          <button type="button" class="btn btn-default" data-dismiss="modal" style="margin:0px 20px;">Pay Now</button></center>
        </div>
      </div>
    </div>
  </div>

  <div id="sendgiftmethod" class="modal fade payment-body" role="dialog">
    <div class="modal-dialog">
        <script type="text/javascript">
          $(document).ready(function() {
            $('.button').on('click', function() {
      ...
      <div class="modal-content" style="height:600px;">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <p class="modal-title" style="text-align: center;">Sent as Gift</>
        </div>
        <div style="color:green;text-align: center;">
            <h3>
              Select Payment Method
        ...
        <div class="main" style="border-bottom: #dedede 1px solid;">
          <div class='payments' style="padding-left:60px;margin-left:0px;">
            <div class='button col-md-3 active' style="font-color:black;">
              <text style="font-size:14px;color:green;">Credit Card</text>
              <svg class="svg-visa" viewBox="0 0 512 512">
        ...
        <div class="col-md-12" style="padding-top:10px;border-bottom: #dedede 1px solid;">
            <form>
                <div style=" width:49.5%; float:left;border-right: 1px dotted #CCC;box-sizing: border-box;padding: 0px 15px 0px 0px;">
                      <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">Surname<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-male" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>
                      <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">Name<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-user" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>
                      <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">E-mail<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-envelope-o" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>
            ...
            <div style="width:49.5%;float:right;box-sizing: border-box;padding: 0px 0px 0px 15px;">  
                <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">City<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-building-o" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>
                      <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">Postcode<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-map-marker" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>  
                      <div class="form-group" style="overflow: hidden;clear: both;font-size:20px;">
                        <p style="margin: 0px;font-weight: 500;line-height: 2;color:#333;">Phone number<span>*</span></p>
                        <span style="width: 35px;float: left;border-radius: 5px 0px 0px 5px;background:#eeeeee;height:30px;position: relative;text-align: center;line-height:30px;"><i class="fa fa-phone" style="color:#555;vertical-align: middle;margin-top: 5px;"></i></span>
                          <input style="width: 200px;float: left;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="nom" id="nom" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                          <div style="display:none;margin: 0 0 10px;font-weight:400;font-size:13px;color: #DE5959;"></div>
                      </div>
            </div>
        ...
        <div class="col-md-12" style="padding-top:10px;text-align: center;">
          <button type="button" class="btn btn-default" data-dismiss="modal" style="margin:0px 20px;">Pay Now</button>
        </div>
      </div>
    </div>
  </div>
